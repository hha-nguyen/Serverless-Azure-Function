...
const { getAllUsers, createUser, getUserByEmail } = require('../userController')
...
router.post(
  ...
  async (req, res) => {
    ...
    // Hash password before savin to database
    ...
    createUser({ email: email, password: hashedPassword})
